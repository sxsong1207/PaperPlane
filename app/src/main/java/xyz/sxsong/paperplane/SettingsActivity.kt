...
import xyz.sxsong.paperplane.LibraryActivity.WebDAV.WebDAVSetup
import xyz.sxsong.paperplane.ZoteroStorage.AttachmentStorageManager
import xyz.sxsong.paperplane.ZoteroStorage.STORAGE_ACCESS_REQUEST
...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (application as PaperPlaneApplication).component.inject(this)
    }
