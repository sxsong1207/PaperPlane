...
import xyz.sxsong.paperplane.ZoteroAPI.*
import xyz.sxsong.paperplane.ZoteroAPI.Model.Note
import xyz.sxsong.paperplane.ZoteroAPI.Syncing.OnSyncChangeListener
...
import xyz.sxsong.paperplane.ZoteroStorage.Database.*
import xyz.sxsong.paperplane.ZoteroStorage.ZoteroDB.ZoteroDB
import xyz.sxsong.paperplane.ZoteroStorage.ZoteroDB.ZoteroDBPicker
import xyz.sxsong.paperplane.ZoteroStorage.ZoteroDB.ZoteroGroupDB
...
import xyz.sxsong.paperplane.ZoteroStorage.Database.Collection as ZoteroCollection
...
//                    }
    ...
    init {
        ((context as Activity).application as PaperPlaneApplication).component.inject(this)
        ...
        ((context as Activity).application as PaperPlaneApplication).component.inject(syncManager)
