...
import xyz.sxsong.paperplane.AttachmentManager.AttachmentManager
import xyz.sxsong.paperplane.LibraryActivity.ItemView.ItemAttachmentEntry
import xyz.sxsong.paperplane.LibraryActivity.ItemView.ItemViewFragment
import xyz.sxsong.paperplane.LibraryActivity.Notes.NoteInteractionListener
import xyz.sxsong.paperplane.LibraryActivity.Notes.NoteView
...
import xyz.sxsong.paperplane.ZoteroStorage.Database.GroupInfo
...
class LibraryActivity : AppCompatActivity(),
    ...
    fun highlightMenuItem(state: LibraryModelState) {
        ...
        * to reflect this change with respect to the item selected.  */
        ...
        } else if (state.currentCollection == "paperplane_my_publications") {
            val navigationView = findViewById<NavigationView>(R.id.nav_view_library)
            navigationView.menu.findItem(MENU_ID_MY_PUBLICATIONS)
        } else if (state.currentCollection == "paperplane_Trash") {
            val navigationView = findViewById<NavigationView>(R.id.nav_view_library)
    ...
    companion object {
        const val ACTION_FILTER =
            "xyz.sxsong.paperplane.intent.action.LIBRARY_FILTER_INTENT"
        const val EXTRA_QUERY = "xyz.sxsong.paperplane.intent.EXTRA_QUERY_TEXT"
    }
